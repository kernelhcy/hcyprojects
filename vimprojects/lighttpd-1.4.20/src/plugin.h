...
typedef struct {
	 ...
	 * is called ... 
	 */
	 handler_t(*handle_trigger) (server * srv, void *p_d);	/* once 
															 * a 
															 * second 
															 */
	 handler_t(*handle_sighup) (server * srv, void *p_d);	/* at 
															 * a 
															 * signup 
															 */
	 ...
	 handler_t(*handle_uri_raw) (server * srv, connection * con, void *p_d);	/* after 
																				 ...
																				 * set 
																				 */
	 handler_t(*handle_uri_clean) (server * srv, connection * con, void *p_d);	/* after 
																				 * uri 
																				 * is 
																				 * set 
																				 */
	 handler_t(*handle_docroot) (server * srv, connection * con, void *p_d);	/* getting 
																				 * the 
																				 * document-root 
																				 */
	 handler_t(*handle_physical) (server * srv, connection * con, void *p_d);	/* mapping 
																				 * url 
																				 * to 
																				 * physical 
																				 * path 
																				 */
	 handler_t(*handle_request_done) (server * srv, connection * con, void *p_d);	/* at 
																					 * the 
																					 * end 
																					 * of 
																					 * a 
																					 * request 
																					 */
	 handler_t(*handle_connection_close) (server * srv, connection * con, void *p_d);	/* at 
																						 * the 
																						 * end 
																						 * of 
																						 * a 
...
int config_append_cond_match_buffer(connection * con,
									data_config * dc, buffer * buf, int n);
