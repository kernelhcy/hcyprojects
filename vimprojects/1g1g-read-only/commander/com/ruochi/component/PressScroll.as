package com.ruochi.component{
	...
	public class PressScroll extends EventDispatcher {
		...
		public function PressScroll(content:DisplayObject, mask:Shape, direction:String, maxSpeed:Number = 32 ) {
			_content = content;
			_mask = mask;
		...
		private function addListeners():void {
			if(_mask.stage){
				_mask.stage.addEventListener(MouseEvent.MOUSE_DOWN, onMaskMouseDown);
			}else {
		...
		private function onMaskAddToStage(e:Event):void {
			_mask.stage.addEventListener(MouseEvent.MOUSE_DOWN, onMaskMouseDown);
			_mask.stage.addEventListener(MouseEvent.MOUSE_UP, onMaskMouseUp);
		}
		
		private function onMaskMouseUp(e:MouseEvent):void {
			removeEnterFrame();
		}
		
		private function onMaskMouseDown(e:MouseEvent):void {
