...
public class ClassInfo {
  ...
  protected static int[] getClassNameIndices(String classDeclaration, String[] genericDeclarations) {
    ...
    if("void".equals(classDeclaration) ||
        "?".equals(classDeclaration) ||
        "boolean".equals(classDeclaration) ||
        "byte".equals(classDeclaration) ||
        "char".equals(classDeclaration) ||
        "short".equals(classDeclaration) ||
        "int".equals(classDeclaration) ||
        "long".equals(classDeclaration) ||
        "float".equals(classDeclaration) ||
        "double".equals(classDeclaration)) {
    } else {
