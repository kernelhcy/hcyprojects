  ...
  protected Component createPopupMenuContent() {
    ...
    list.setCellRenderer(new DefaultListCellRenderer() {
      public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        DefaultListCellRenderer renderer = (DefaultListCellRenderer)super.getListCellRendererComponent(list, name, index, isSelected, cellHasFocus);
        renderer.setIcon(IconManager.getIcon((classInfo.isLoaded()? 0: Modifiers.NOT_LOADED) | classInfo.getModifiers()));
    ...
    ActionListener actionListener = new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        classPane.addClasses(classNameField.getText(), (ClassProcessor)classProcessorComboBox.getSelectedItem());
        adjustList(list);
      }
    };
    ...
    browseClassesButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        final JTree tree = new JTree(new DefaultTreeModel(new DefaultMutableTreeNode("Classes")));
